...
function importar(){ 
  ...
  var parametros = new FormData($("#importar_data")[0]);
      $.ajax({
          ...
          processData:false,
          beforeSend: function() {
       			$("#mensaje").addClass('alert alert-warning alert-dismissable text-center mensaje_alerta_importacion');
                $('#mensaje').text('Enviando Data Espere');
   			 },         
          success: function(data){ 
          	$("#mensaje").removeClass('alert alert-warning alert-dismissable text-center mensaje_alerta_importacion');
            ...
            window.location.href = '././importar.php';
          	...
          	$("#mensaje").removeClass('alert alert-success alert-dismissable text-center mensaje_alerta_importacion');
            $("#mensaje").addClass('alert alert-danger alert-dismissable text-center mensaje_alerta_importacion');
...
function exportar(){ 
  ...
  var clave_importar=document.getElementById('clave_exportar').value;

      if (clave_importar!='5050' )
      {
      $("#mensaje_exportar").addClass('alert alert-danger alert-dismissable text-center mensaje_alerta_importacion');
      $('#mensaje_exportar').text('Clave Incorrecta');
      document.getElementById('clave_exportar').focus();
      return false;
      }else{
      $("#mensaje_exportar").removeClass('alert alert-danger alert-dismissable text-center mensaje_alerta_importacion');	
      $("#mensaje_exportar").addClass('alert alert-success alert-dismissable text-center mensaje_alerta_importacion');
      $('#mensaje_exportar').text('Data Importada');
      	window.location.href="././exportar_cliente.php";
      }
